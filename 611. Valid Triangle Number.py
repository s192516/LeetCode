        ...
        for i in range(m-2):
            for j in range(i+1,m-1):
                for k in range(j+1,m):
                    if a[i] + a[j] > a[k]:
                        ans += dict1[a[i]]*dict1[a[j]]*dict1[a[k]]
        # print(ans -80688225)
        return ans
...
#                 n = dict1[nums[i]]
#
#                 if (n == 2 and nums[i] * 2 > nums[j]) or dict1[nums[j]] == 2:
#                     ans += n * dict1[nums[j]] // 2
#                 # if n >= 3:
#
#
#         if nums[-1] != 0 and dict1[nums[-1]] == 0:
#             ans += q - 2
#         print(ans)
#
#         for i in range(m-2):
...
#
#                         ans += dict1[nums[i]] * dict1[nums[j]] * dict1[nums[k]]
#                     else:
#                         break
#         return ans

a = Solution()
q = a.triangleNumber(nums)
print("q =",q)